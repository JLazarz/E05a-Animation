...
SCREEN_WIDTH = 640         #11-13 same as main1.py
SCREEN_HEIGHT = 480
SCREEN_TITLE = "Move Keyboard Example"
MOVEMENT_SPEED = 3     #How fast the ball moves


class Ball:   #17-50 Same as main1.py
...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        arcade.start_render()
        self.ball.draw()    #Opens with window
    ...
    def on_key_press(self, key, modifiers):
        ...
        if key == arcade.key.LEFT:                         #75-84 is which way the ball moves
